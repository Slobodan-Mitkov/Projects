                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form id="TestimonialForm" action="{{ route('testimonials.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="testimonial_text" name="testimonial_text" class="form-control">{{ old('testimonial_text') }}</textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="client_position" name="client_position" class="form-control" value="{{ old('client_position') }}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="client_company" name="client_company" class="form-control" value="{{ old('client_company') }}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="client_profile_picture" name="client_profile_picture" class="form-control" value="{{ old('client_profile_picture') }}">
                        </div>
